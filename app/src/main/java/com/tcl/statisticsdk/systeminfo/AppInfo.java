...
public class AppInfo {
    ...
    public static AppInfo getInstance() {
        synchronized (AppInfo.class) {
            if (sInstance == null) sInstance = new AppInfo();
        }
    ...
    public void getPackageInfo(Context context) {
        ...
        try {
            ...
            mLaunchActivityName =
                    context.getPackageManager().getLaunchIntentForPackage(mBundleId).getComponent().getClassName();
    ...
    public void setAppinfo(Context context, JSONObject appinfo) {
        ...
        try {
            ...
            appinfo.put(
                    "a",
                    (StatisticsConfig.getAPPVersion(mContext) == 0) ? mVersionCode : StatisticsConfig
